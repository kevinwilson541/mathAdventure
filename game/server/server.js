...
server: {
	ssl: true,
	auto_reconnect: true,
	sslCert: fs.readFileSync('/home/users/adampond/.ssl/mongodb-cert.crt'),
	sslKey: fs.readFileSync('/home/users/adampond/.ssl/mongodb-cert.key') 
	}
};
...
var weboptions= { key: fs.readFileSync('/home/users/adampond/.ssl/agentkey.pem'),
		  cert: fs.readFileSync('/home/users/adampond/.ssl/agentcert.crt')
	      };
